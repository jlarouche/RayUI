...
if loc == "zhCN" then
    ...
    ButtonTexts = {
        tutorial = "Tips Tutorial",
        skip = "Skip",
        finished = "Finished",
    }
    ToolTipStrings = {
        config =			ToolTipColors[6].."You can configure the console.|r",
    }
    ToolTipTexts = {
        general =				ToolTipColors[1].."Console|r\n\n"..ToolTipColors[3].."In the system menu, click RayUI to configure the console|r\n\n",
        minimap =			ToolTipColors[1].."Minimap|r\n\n"..ToolTipColors[2].."Right Click: |r"..ToolTipColors[3].."Show tracking menu|r\n"..ToolTipColors[2].."Middle-Click: |r"..ToolTipColors[3].."Show system menu|r",
        playerframe =		ToolTipColors[1].."Player frame|r\n\n"..ToolTipColors[4].."Display:|r\n"..ToolTipColors[3].."Fighting\nTargeted\Casting\nLife, mana|r\n\n"..ToolTipStrings.config,
        targetframe =		ToolTipColors[1].."Target frame|r\n\n"..ToolTipColors[4].."Focus:|r\n"..ToolTipColors[3].."Middle-Click to focus target|r",
        focusframes =		ToolTipColors[1].."Focus frame|r\n\n"..ToolTipColors[4].."Remove focus:|r\n"..ToolTipColors[3].."Middle-Click something something...|r",
        actionbars =		ToolTipColors[1].."Main action bar|r\n\n"..ToolTipColors[2].."Action bars:|r\n"..ToolTipColors[3].."Action bar 1, 2, 3|r\n\n"..ToolTipColors[4].."Display:|r\n"..ToolTipColors[3].."Battle\nTargeted\nVehicules\nSpellbook interface and macro|r\n\n"..ToolTipStrings.config,
        chatframe =		ToolTipColors[1].."Chatbox|r\n\n"..ToolTipColors[2].."自動隱藏:|r\n"..ToolTipColors[3].."After a while without message it will autohide, you can also click on the left to slide the chatbox out.|r\n\n"..ToolTipStrings.config,
    }
end
